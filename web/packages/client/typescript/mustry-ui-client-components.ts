...
import {
  BranchingComponent,
  BranchingComponentMeta,
} from "./components/branchingComponent/BranchingComponent/BranchingComponent";
...
const components: Array<ComponentMeta> = [new BranchingComponentMeta()];
